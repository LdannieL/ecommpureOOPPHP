	...
	<div id="header_in">
		...
		<?php
			if (Login::isLogged(Login::$_login_front)) {
				...
				echo '</strong> | <a href="/ecommerce/?page=orders">My orders</a>';
				echo ' | <a href="/ecommerce/?page=logout">Logout</a></div>';				
			} else {
				echo '<div id="logged_as"><a href="/ecommerce/?page=login">Login</a></div>';
			}
		?>
	</div>
</div>
	...
	<div id="wrapper">
		<div id="left">
			...
			<ul id="navigation">
				<?php 
					foreach($cats as $cat) {
						echo "<li><a href=\"/ecommerce/?page=catalogue&amp;category=".$cat['id']."\"";
